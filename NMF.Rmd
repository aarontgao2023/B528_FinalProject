...
## rank selection
This function is very time consuming and always cause problem when rendering the md file. However I run it individually and get the ultimate rank 3. Therefore I will skip this chunk when rendering the md file
```{r, eval=FALSE}
